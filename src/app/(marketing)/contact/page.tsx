...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!nameSchema.safeParse(name).success) nextErrors.name = "Enter your name";
    if (!emailSchema.safeParse(email).success) nextErrors.email = "Please enter a valid email address.";
    if (phone) {
      if (!phoneSchema.safeParse(phone).success) nextErrors.phone = "Please enter a valid phone number.";
    }
            ...
            <Card className="h-full p-6">
              ...
              <div className="mt-4 rounded-xl border border-brand-500/30 bg-brand-600/5 p-4">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  ...
                  <Link href="/internships/apply" className="text-brand-400 hover:underline">
                    /internships/apply
                  </Link>
                  .
                </p>
